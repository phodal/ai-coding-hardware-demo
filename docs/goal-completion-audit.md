...
| web-ai-button | P1 | required_external | none | passed `.logs/hardware-smoke-suite/20260615-081705/summary.json` | external-required | Local-network evidence exists; keep `.env` credentials ignored and record supervised physical tap evidence before promoting this external lane. |
