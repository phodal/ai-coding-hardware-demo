...
- For AMOLED overexposure or color mismatch, first validate with `DISPLAY_BRIGHTNESS=96 OCR_PREPROCESS_MODE=color CAMERA_EXPOSURE_POINT=0.5,0.65 CAMERA_FOCUS_POINT=0.5,0.65 make visual-smoke`; the calibration sketch renders large `OK` text plus red/green/blue/yellow swatches.
